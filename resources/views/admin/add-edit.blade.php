            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ Route('admin.update.add', $add->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="text" value="{{ old('link', $add->link) }}" class="form-control" id="" required name="link" placeholder="link">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div id="image-preview">
                                        @if($add->image != NULL)
                                        <img src="{{ asset('/adds/'.$add->image) }}" alt="" width="150px">
