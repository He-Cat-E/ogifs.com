                        ...
                        <div class="row mx-0 justify-content-center">
                            ...
                            <div class="col-lg-10 pt-5 pb-2 login__area">
                                ...
                                <div class="d-flex align-items-center gap-2 justify-content-center mt-4 mb-1">
                                    ...
                                    <input type="file" name="file" id="hiddenInput" hidden required>
                                </div>
                                        ...
                                        if (e.target.files.length > 0) {
                                            ...
                                            reader.onload = function(e) {
                                                ...
                                                if (file.type.startsWith('image/')) {
                                                    ...
                                                    // You can add more conditions for different media types if needed
                                                    alert('Unsupported media type uploaded!');
                                                    return;
                                                }
                            ...
                            <div class="row px-lg-5 pb-2 ">
                                ...
                                <div class="col-lg-12 pt-lg-5 login__area">
                                    ...
                                    <textarea name="description" class="form-control desc_" placeholder="Please enter description" maxlength="370" required></textarea>
                                    <span style="color:red" class="desc_error"></span>
                                </div>
                                ...
                                <div class="col-lg-6 pt-lg-5 login__area">
                                    <div class="upload__heading">
                                        <div class="form-group">
                                            <label for=""><span class="gradient-color fw-700">Select
                                                    Type</span></label>
                                            <select name="type" id="" class="form-control select_type" required>
                            ...
                            <div class="upload__heading mb-2 text-center mt-3">
                                <button class="btn btn-dark btn-lg upload_" type="submit">
                                    Upload
                                </button>
                            </div>
...
<div class="spinner_" style="position: fixed;top: 0;width: 100%;height: 100%;background-color: #0009;display: none;align-items: center;justify-content: center;">
...
<script>
    $('.select_type').change(function() {
        ...
        var html = ` <div class="col-lg-6 login__area for_sound">
                                ...
                                <div class="col-lg-6  login__area for_sound">
                                    <div class="upload__heading mb-2">
                                        <div class="form-group">
    ...
    $('.upload_').click(function() {
        $('.form-control').each(function() {
            var vl = $(this).val();
            if (vl !== '') {
                $('.spinner_').css('display', 'flex');
            }
        });
    });

    $('.desc_').keyup(function(){
        var desc = $(this).val().length;
        if(desc >= 370){
            $(this).next('.desc_error').text('You can type maximum 370 Characters');
            $('.upload_').attr('disabled', true);
        }else{
            $(this).next('.desc_error').text('');
        }
    });
