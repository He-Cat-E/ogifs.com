            ...
            <div class="row mx-0 justify-content-start align-items-center">
                ...
                <div class="col-lg-3 mt-3">
                    ...
                    <div class="d-flex align-items-center mt-3 gap-1">
                        <button class="btn btn-danger" type="button" data-bs-toggle="modal" data-bs-target="#delete{{ $loop->iteration }}">
                        ...
                        <button class="btn btn-info" onclick="clickToCopy('{{ route('detail.page', ['id' => $gif->id]) }}')">
...
{{-- Script For Click To copy --}}
<script>
    function clickToCopy(textToCopy) {
        ...
        // Optionally, provide feedback to the user (e.g., alert or toast)
        alert('Copied');
    }
